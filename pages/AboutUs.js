...
export default class AboutUs extends Component{
    render(props) {
        return (
            <MobileLayout title={`درباره ما`} style={{padding:'4',height:'fit-content'}}>
                <Toolbar customStyle={toolbarStyle}/>
                <AndroidBackButton onPress={()=>{
                    Router.back()
                }}/>
                <img src={images.bg_About_Shadow} style={{maxWidth:'100%',maxHeight:'100%',position:'sticky',top:0}}/>
                ...
                <div style={{position:'fixed',bottom:0,backgroundColor:'white',maxWidth:'100%',width:global.width,textAlign:'center'}}>
