...
const MobileLayout = observer( props => {
    ...
    return (
        <div dir={"rtl"}  style={{ display: 'flex',flex:1,  justifyContent:'center',  height: '100%',backgroundImage: `url(${images.publicPg})`}}>
            <DrawerPanel onRef={initDrawerData=>initDrawer=initDrawerData} title={'منوی من'} open={props.showMenu || persistStore.showMenu  }   onClose={props.onCloseMenu}></DrawerPanel>
