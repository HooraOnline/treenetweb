...
import {orange1, bg6, bgScreen, bgWhite, border, primaryDark, textItem} from "../../constants/colors";
        ...
        >
            <div  ref={ref}   style={{
                ...
                <View style={[props.style,{width:'100%',height:'100%'}]}>
                    ...
                    <div id={"header"} style={{position:'fixed',maxHeight:50, top:0,width:globalState.width,zIndex:4,marginBottom:0}}>
                        {props.header}
                    </div>

                    <View id={'body'} style={{flex:1,width:globalState.width,height:'100%', marginTop:props.header?50:0,marginBottom:props.footer?60:0}}>
