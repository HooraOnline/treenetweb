...
export default class PersianCalendarPickerPopup extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            dialogVisible: props.open || false,
        };
    }
    ...
    selectToday() {
        let date=new Date();
        date=jMoment.utc(new Date()).format('YYYY-MM-DD');
        this.props.onValueChange(mapNumbersToEnglish(date));
        this.setState({dialogVisible: false});
    }
            ...
            <View style={[style,{flex:1}]}>
                <TouchableOpacity
                    style={{
                        ...
                        paddingStart: 7,
                        borderColor: validation ? subTextItem : lightRed,
                    }}
                        ...
                        <TouchableWithoutFeedback style={[{},style]} >
                            <View style={{
                                ...
                                >
                                    ...
                                    {showToday && (
                                        <TouchableOpacity
                                            style={{alignSelf: 'flex-end', paddingHorizontal: 10, marginVertical:10}}
